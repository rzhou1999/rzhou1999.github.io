...
function showProjects() {
    ...
    document.getElementById("content").innerHTML = multiline(function(){/*
      ...
      <div class="project-tab project-stockmarketproject" onclick="window.open('https://github.com/rzhou1999/repapp');typeNormal('ls web/repapp<br>','~/projects');">
...
function showLinks() {
  ...
  document.getElementById("content").innerHTML = multiline(function(){/*
    ...
    <div class="links">
      <div class="link" onclick="window.open('resume_web.pdf');typeNormal('cat resume.pdf<br>','~/links');">
        <h3 class="link-title">Resume</h3>
        <span class="mega-octicon octicon-file-pdf"></span>
      </div>
      <div class="link" onclick="window.open('https://github.com/rzhou1999/');typeNormal('ls github<br>','~/links');">
...
function typeNormal(inp, newDir){
  ...
  if (savedText.length >= 7){
      while (savedText.length >= 7){
        savedText.shift();
      }
